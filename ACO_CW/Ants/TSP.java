...
public class TSP {
    ...
    private Graph graph;
    private int numAnts, numGenerations;

    /**
     * constructor for tsp
     * @param numAnts         number of ants to run per generation
     * @param numGenerations   number of generations
     * @param evaporation   frequency of evaporation
     * @param alpha         power of pheromone over probability
     * @param beta          power of distance  over probability
     */
    public TSP(int numAnts, int numGenerations, double evaporation, int alpha, int beta) {
        this.numAnts = numAnts;
        this.numGenerations = numGenerations;
        graph = Input.Import.convertGraph(evaporation, alpha, beta);
    }
